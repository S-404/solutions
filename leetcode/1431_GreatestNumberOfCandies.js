...
where each candies[i] represents the number of 
...
they will have the greatest number of 
candies among all the kids, or false otherwise.

Note that multiple kids can have 
...
let cases = [
    { id: 0, candies: [2, 3, 5, 1, 3], extraCandies: 3 },
    { id: 1, candies: [4, 2, 1, 1, 2], extraCandies: 1 },
    { id: 2, candies: [12, 1, 12], extraCandies: 10 },
]
for (let c of cases) {
    console.log(`case:"${c.id}" - result:"${JSON.stringify(kidsWithCandies(c.candies, c.extraCandies))}"`)
}